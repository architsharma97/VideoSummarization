...
def main():
	...
	num_centroids=percent*frame_count/skim_frames_length+1
	...
	for centre in centres:
    	for idx in range(centre*sampling_rate-skim_frames_length/2,centre*sampling_rate+skim_frames_length/2+1):
